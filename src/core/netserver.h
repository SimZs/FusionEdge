...
<title>FusionEdge - WEB Board Uploader</title><style>html, body { margin: 0; padding: 0; height: 100%; } body{background-color: #000;color: #96c30a;font-size:20px;display:flex;flex-direction:column;font-family:"Roboto","Helvetica Neue",Arial,sans-serif;font-weight:400;}
...
.hidden{display:none;}a { color: #96c30a; text-decoration: none; font-weight: bold } a:hover { text-decoration: underline }
...
#scan_wifi_btn{border:2px solid #96c30a;color:#000;background-color:#96c30a;border-radius:25px;font-size:20px;padding:0 24px;height:46px;box-sizing:border-box;cursor:pointer;font-family:"Roboto","Helvetica Neue",Arial,sans-serif;font-weight:400;}
...
input[type=text],input[type=password]{width:170px;background: #272727;color: #96c30a;padding:6px 12px;font-size:20px;border: #2d2d2d 1px solid;margin:4px 0 0 4px;border-radius:4px;outline:none;}
...
<section>
<h2>FusionEdge - WEB Board Uploader</h2>
<div id="apintro">
<hr />
...
<div id="copy">powered by <a target="_blank" href="https://github.com/SimZs/yoRadio-Fusion">FusionEdge</a><span id="version"></span></div>
</body>
<script>
...
<head>
  ...
  <meta name="theme-color" content="#96c30a">
