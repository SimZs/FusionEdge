...
const FillConfig   metaBGConf     PROGMEM = {{ 3, 89, 0, WA_CENTER }, DSP_WIDTH - 6, 1, true };
...
const textBoxConfig bootstrConf   PROGMEM = {40, 146, 240, 30, 16, WA_CENTER, 1, 4, true, 0, 0};
const textBoxConfig ipBoxConf     PROGMEM = {6, 216, 110, 18, 10, WA_CENTER, 1, 3, true, 0, 0};
...
const textBoxConfig rssiBoxConf   PROGMEM = {228, 216, 52, 18, 10, WA_CENTER, 1, 3, true, 0, 0};
...
const WidgetConfig clockConf      PROGMEM = { 178, 132, 52, WA_RIGHT };
const WidgetConfig dateConf       PROGMEM = { TFT_FRAMEWDT, 93, 16, WA_CENTER };
...
/* BITRATE */
const BitrateBoxConfig bitrateConf PROGMEM = { (uint16_t)(DSP_WIDTH - TFT_FRAMEWDT - 70), 73, 12, WA_RIGHT, 1, 3, false, 2, 1, 34 };

/* PLAYMODE */
const BitrateBoxConfig pmodeConf   PROGMEM = { TFT_FRAMEWDT+84, 73, 12, WA_LEFT, 1, 3, false, 2, 1, 34 };
...
/* MOVES  */
const MoveConfig clockMove PROGMEM = { 178, 132, -1 };
