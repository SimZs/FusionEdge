...
// Cassette screensaver: the widget is always compiled in and switched at
// runtime via the "screensaverstyle" web UI option (Clock/Cassette/VU Meter),
// so it no longer needs to be enabled in myoptions.h. myoptions.h may still
// #define/#undef this before this point to force it in/out of the build.
#ifndef USE_CASSETTE_SCREENSAVER
#    define USE_CASSETTE_SCREENSAVER
#endif

// Album cover screensaver: shows the same last.fm/MusicBrainz cover art used
// by the small station icon, full-screen, when screensaverStyle == 3. Only
// makes sense if cover art fetching is actually built in, so it rides on
// USE_LASTFM_COVER instead of its own myoptions.h toggle. myoptions.h may
// still #define/#undef USE_COVERART_SCREENSAVER before this point to force
// it in/out of the build.
#ifndef USE_COVERART_SCREENSAVER
#    ifdef USE_LASTFM_COVER
#        define USE_COVERART_SCREENSAVER
#    endif
#endif
...
/*        Other settings. You can overwrite them in the myoptions.h file        */
  ...
  #define NAMEDAYS_FILE HU  // Namedays file for the selected language. Supported languages: HU, PL, NL, GR, DE
#endif
#ifndef MUTE_PIN
...
#define CLOCKFONT_STYLE_OLDTIMER 3
#define CLOCKFONT_STYLE_LARADOT 4
#define CLOCKFONT_STYLE_DECODERR 5
#define CLOCKFONT_STYLE_SQUAREFONT 6
...
#endif
#ifndef COLOR_STATUS_ACTIVE
  #define COLOR_STATUS_ACTIVE     100, 220, 100
#endif
#ifndef COLOR_STATUS_INACTIVE
  #define COLOR_STATUS_INACTIVE    60,  60,  60
#endif

#ifndef COLOR_WEATHER_ICON_TXT
  #define COLOR_WEATHER_ICON_TXT  255, 255, 255
#endif
...
#ifndef COLOR_BUFF
  #define COLOR_BUFF              165, 210, 140
#endif
#ifndef COLOR_BUFF_BG
  #define COLOR_BUFF_BG             0,   0,   0
#endif
#ifndef COLOR_BUFF_BORDER
  #define COLOR_BUFF_BORDER       102, 178, 255
#endif
#ifndef COLOR_BUFF_INACTIVE
  #define COLOR_BUFF_INACTIVE      40,  40,  40
#endif
#ifndef COLOR_BUFF_ICON
  #define COLOR_BUFF_ICON         165, 210, 140
#endif
#ifndef COLOR_RSSI
